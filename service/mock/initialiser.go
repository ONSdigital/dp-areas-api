...
//             },
//             DoGetMongoDBFunc: func(ctx context.Context, cfg *config.Configuration) (api.MongoServer, error) {
...
func (mock *InitialiserMock) DoGetMongoDB(ctx context.Context, cfg *config.Configuration) (api.MongoServer, error) {
