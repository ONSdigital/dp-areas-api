...
func TestRun(t *testing.T) {
	...
	Convey("Having a set of mocked dependencies", t, func() {
		...
		//!!! and any other mongo checks from dp-image-api
		...
		//!!! try adding from dp-image-api: Convey("Given that Checkers cannot be registered", func() {
		...
		//!!! from dp-image-api: Convey("Given that all required dependencies are successfully initialised in web mode", func() {
	})
}
